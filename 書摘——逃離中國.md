...
<head>
    ...
    <style>
        ...
        .description-container {
            ...
            padding: 0;
            margin-top: 10px;
            background-color: #f8f9fa; /* 使用一個淺色背景讓文字清晰 */
            max-height: 0;
            overflow: hidden;
...
<body>
    ...
    <p>
        此法案得以通過的關鍵，在於它屬於<span id="highlighted-topic" class="highlight-text">預算調和機制</span>的特殊立法程序。
    </p>
