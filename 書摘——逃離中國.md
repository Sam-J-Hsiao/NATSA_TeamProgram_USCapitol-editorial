...
<head>
    ...
    <style>
        ...
        .description-container {
            border-radius: 10px;
            padding: 0 15px; /* 修正 padding 設定，只在左右保留空間 */
            margin-top: 10px;
        ...
        .description-container.active {
            padding-top: 15px; /* 展開時設定 top padding */
            padding-bottom: 15px; /* 展開時設定 bottom padding */
        }
...
<body>
    ...
    <p>
        One Big Beautiful Bill Act（OBBBA），中譯簡稱<a href="https://www.congress.gov/119/bills/hr1/BILLS-119hr1enr.pdf" target="_blank" rel="noopener noreferrer">大而美法案</a>，其正式名稱為「為符合眾議院第14號決議第二章之和解提供規定之法案」，在第119屆美國國會通過並由美國總統川普於2025年7月4日簽署生效。
    </p>
    <p>
        大而美法案所牽涉的範圍極廣，在870頁的條款中包含經濟、醫療保健、社會福利、移民與邊境安全以及國家安全與國防等領域的聯邦政策。同時法案也是延續了川普在2017年所提出的減稅法案（2017年減稅與就業法案）。
    </p>
    <p>
        此法案得以通過的關鍵，在於它屬於<span id="highlighted-topic" class="highlight-text">預算調和文字</span>的特殊立法程序。
    </p>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (topicElement && descriptionBox) {
                topicElement.addEventListener('click', function() {
                    const isActive = descriptionBox.classList.toggle('active');
                    if (isActive) {
...
<body>
    ...
    <h1>美國國會立法過程</h1>
    <p>
        大而美法案正式的名稱會是「為符合眾議院第14號決議第二章之和解提供規定之法案」，之所以會有如此複雜的名稱，主要的原因是共和黨為了通過這樣的法案，運用了大量的立法程序作為工具。
    </p>
    <p>
